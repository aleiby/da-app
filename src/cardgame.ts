...
export abstract class CardGame {
  ...
  onClickDeck(fn: OnClickDeckFn) {
    this._onClickDeck = fn;
  }

  _onRightClickDeck: OnClickDeckFn | null = null;
  onRightClickDeck(fn: OnClickDeckFn) {
    this._onRightClickDeck = fn;
  }

  _onClickTable: OnClickTableFn | null = null;
  onClickTable(fn: OnClickTableFn) {
    this._onClickTable = fn;
  }

  _onRightClickTable: OnClickTableFn | null = null;
  onRightClickTable(fn: OnClickTableFn) {
    this._onRightClickTable = fn;
  }
